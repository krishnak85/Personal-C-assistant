...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning krishna"<<endl;
        string phrase = "Good Morning master krishna";
        ...
        cout<< "Good Afternoon Master krishna"<<endl;
        string phrase = "Good Afternoon Master krishna";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening Master krishna"<<endl;
        string phrase = "Good Evening Master krishna";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER KRISHNA|"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER KRISHNA";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="krishna")
        {
            ...
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you Master krishna...."<<endl<<endl;

                string phrase = "How can i help you Master krishna";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"Hello Master krishna....."<<endl;
                    string phrase = "Hello Master krishna";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"I'm a personal assistant created by Master krishna !!!"<<endl;
                    string phrase = "I'm a personal assistant created by Master krishna !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"Good Bye Master krishna, see you soon!"<<endl;
                    string phrase = "Good Bye Master krishna, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
